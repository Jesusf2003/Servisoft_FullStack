...
import com.springboot.servisoft.repository.ProductoRepository;
...
public class ProductoService implements ProductoRepository {
    ...
    @Autowired
    public ProductoRepository prodrep;
    ...
    public List<Producto> findAllById(Iterable<Long> longs) {
        return prodrep.findAllById(longs);
    }
